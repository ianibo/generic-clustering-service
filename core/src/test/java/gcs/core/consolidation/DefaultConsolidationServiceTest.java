...
class DefaultConsolidationServiceTest {
    ...
    void testMerge() {
        ...
        when(anchorPort.createCluster(newAnchor, "work", "Consolidated Cluster")).thenReturn(newClusterId);
    ...
    void testSplit() {
        ...
        verify(anchorPort).createCluster(newAnchor1, "work", "Split Cluster 1");
        verify(anchorPort).createCluster(newAnchor2, "work", "Split Cluster 2");
    }
}
